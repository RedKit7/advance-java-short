...
public class TestDrive {
    ...
    public static void main(String[] args) {
        ...
        // 3
        java.util.Optional<List<Insan>> insan3 = ofNullable(insanDolu); // null değer alır // ? NosuchElement
        ...
        /*
         * Methods:
         * isPresent() 	null kontorülüdür. Boş ise false, Dolu ise true değerini döndürür. (var mı)
         * orElse()	kullanici.get().get(0).getName().orElse("Ali"); şeklinde bir şart ile true ya da false değer döndürerek gerekli nesneyi seçebilirsiniz (eğer değer mevcutsa al yoksa verileni al)
         * orElseGet()	Nesne içerisinde eğer bir değer null ise varsaydığımız değeri göndeerebiliyoruz. ()
         * ifPresent()	Eğer null değilse istediğimiz işlemleri ise bu parametre ile yapmaktayız. (Varsa yap)
         */
        ...
        Integer yas = java.util.Optional.ofNullable(nullYas).orElse(25);
